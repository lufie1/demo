...
<body>
  <h1>Menu Management</h1>      
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:800px;height:380px;" allowResize="true"
        url="../MenuCrudServlet?method=search"  pageSize="20"  idField="id" multiSelect="true" 
    >
    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            mini.open({
                url: bootPATH+"../menu/menuWindow.html",
        ...
        function remove() {
            ...
            if (rows.length > 0) {
                if (confirm("Confirm delete this record?")) {
                    ...
                    $.ajax({
                        url: bootPATH+"../MenuCrudServlet?method=remove&id=" +id,
